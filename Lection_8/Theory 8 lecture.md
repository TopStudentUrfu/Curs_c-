...
## **0. Немного о sqlite3**  
Библиотека **sqlite3** в C++ предоставляет интерфейс для работы с легковесной реляционной базой данных SQLite, которая хранится в виде единого файла на диске. Вот ключевые аспекты:

### Основные особенности:
1. **Встраиваемая**  
   Не требует отдельного сервера — БД работает в процессе приложения.
2. **Нулевая конфигурация**  
   Не нужна установка или администрирование.
3. **Кросс-платформенность**  
   Поддерживает Windows, Linux, macOS, мобильные ОС.
4. **Полная поддержка SQL**  
   Включает транзакции, триггеры, представления, JSON.
5. **Лицензия Public Domain**  
   Бесплатна для любых целей.

> Пример использования: история браузера, кэширование данных, конфигурационные файлы.
...
- `sqlite3_column_int64()` для 64-битных целых.
- `sqlite3_column_text16()` для Unicode-строк.
